...
import styles from './AmrcDashboardWebPart.module.scss';
import * as strings from 'AmrcDashboardWebPartStrings';
...
export interface IAmrcDashboardWebPartProps {
  description: string;
  test: string;
  test1: boolean;
  test2: string;
...
export default class AmrcDashboardWebPart extends BaseClientSideWebPart<IAmrcDashboardWebPartProps> {
